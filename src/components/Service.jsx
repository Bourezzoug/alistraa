...
const Service = () => {
    ...
    <div class="container mx-auto p-6 max-w-3xl" data-aos="zoom-in" data-aos-offset="300"  data-aos-duration="500">
    ...
    <div class="container mx-auto p-6">
        <div class="grid grid-cols-12 gap-16">
            <div class="col-span-12 md:col-span-6 lg:col-span-4 hover:shadow-9xl transition-all p-6 w-1/2 md:w-full" data-aos="zoom-in" data-aos-offset="300"  data-aos-duration="500"> 
